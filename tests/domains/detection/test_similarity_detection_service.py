...
class TestSimilarityDetectionServiceIntegration(unittest.TestCase):
    ...
    def test_full_similarity_analysis_workflow(self):
        ...
        tokens1 = [
            {'type': 'function_definition', 'text': 'def fibonacci(n):\n    if n <= 1:\n        return n\n    return fibonacci(n-1) + fibonacci(n-2)', 'start': 0, 'end': 3},
        ...
        tokens2 = [
            {'type': 'function_definition', 'text': 'def fib(num):\n    if num <= 1:\n        return num\n    return fib(num-1) + fib(num-2)', 'start': 0, 'end': 3},
    ...
    def test_realistic_code_comparison(self):
        ...
        tokens1 = [
            {'type': 'function_definition', 'text': 'def calculate_area(radius):\n    pi = 3.14159\n    return pi * radius * radius', 'start': 0, 'end': 2},
            {'type': 'assignment', 'text': 'pi = 3.14159', 'start': 1, 'end': 1},
            {'type': 'return_statement', 'text': 'return pi * radius * radius', 'start': 2, 'end': 2}
        ]
        tokens2 = [
            {'type': 'function_definition', 'text': 'def compute_volume(r, h):\n    pi = 3.14159\n    return pi * r * r * h', 'start': 0, 'end': 2},
            {'type': 'assignment', 'text': 'pi = 3.14159', 'start': 1, 'end': 1},
    ...
    def test_no_similarity_detection(self):
        ...
        tokens1 = [
            {'type': 'class_definition', 'text': 'class Person:\n    def __init__(self, name):\n        self.name = name', 'start': 0, 'end': 2}
        ]
        tokens2 = [
