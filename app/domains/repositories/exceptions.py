...
class UnsupportedRepositoryException(RepositoryFetchException):
    ...
    def __init__(self, url: str, supported_types: list = None):
        ...
        super().__init__(
            message,
            source_url=url,
            details={"error_type": "unsupported_repository", "url": url, "supported_types": supported_types or []},
        )
...
class S3ConfigurationException(S3FetchException):
    ...
    def __init__(self, message: str, s3_url: str = None):
        super().__init__(
            message, s3_url or "unknown", details={"error_type": "s3_configuration_error", "message": message}
        )
...
class S3BucketException(S3FetchException):
    ...
    def __init__(self, bucket: str, s3_url: str, error_code: str = None):
        ...
        super().__init__(
            ...
            s3_url,
            bucket,
            details={"error_type": "s3_bucket_error", "bucket": bucket, "error_code": error_code, "url": s3_url},
        )
...
class TemporaryDirectoryException(ValidationException):
    ...
    def __init__(self, operation: str, error: str, path: str = None):
        ...
        super().__init__(
            message,
            details={"error_type": "temporary_directory_error", "operation": operation, "error": error, "path": path},
        )
